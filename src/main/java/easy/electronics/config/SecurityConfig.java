package easy.electronics.config;
...
import easy.electronics.config.ajax.AjaxAuthenticationFailureHandler;
import easy.electronics.config.ajax.AjaxAuthenticationSuccessHandler;
import easy.electronics.config.ajax.AjaxLogoutSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			.authorizeRequests()
			.antMatchers("/", "/latest/*", "/categories", "/categories/**", "/signin", "/api/account", "/article").permitAll()
