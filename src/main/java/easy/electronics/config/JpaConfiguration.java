...
@Configuration
@EnableJpaRepositories(basePackages = "easy.electronics.repositories")
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] {"easy.electronics"});
	...
	public AnnotationMethodHandlerAdapter adapter() {
		...
		adapter.setCustomArgumentResolver(pageableArgumentResolver());
		return adapter;
	}
